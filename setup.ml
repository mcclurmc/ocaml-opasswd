...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9cd639a0b72120a6a8052f65c6115e76) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_c_sources =
                        ["shadow_stubs.c"; "common_stubs.c"; "common.h"];
                      bs_data_files = [];
                      bs_ccopt =
                        [(OASISExpr.EBool true, ["-Wall"; "-O3"; "-g"])];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "F|\201\b\250\140\b\199\167\136\170\000\255\25363";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
